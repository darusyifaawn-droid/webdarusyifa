...
export default function DriveJuknisModal({ isOpen, onClose }: DriveJuknisModalProps) {
 ...
 <div className="bg-white w-full max-w-2xl rounded-[2rem] shadow-2xl overflow-hidden my-auto border border-slate-100 flex flex-col max-h-[90vh] text-slate-800 ">
 ...
 {/* Example Format Box */}
 <div className="bg-slate-900 text-white p-4 sm:p-5 rounded-2xl space-y-2 border border-slate-800">
