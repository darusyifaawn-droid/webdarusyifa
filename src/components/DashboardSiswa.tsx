          ...
          <div className="space-y-6 pb-24 md:pb-0 animate-in fade-in duration-500">
            ...
            <div className="md:hidden -mx-4 -mt-3 mb-6 bg-gradient-to-br from-blue-500 to-blue-600 p-8 rounded-b-[40px] text-white relative">
              ...
              <div className="flex items-center gap-5 bg-white/15 p-6 rounded-[3rem] backdrop-blur-xl border border-white/30 relative z-10 shadow-2xl overflow-hidden">
                <div className="w-20 h-20 rounded-[2.2rem] border-4 border-white/40 overflow-hidden bg-white/95 flex items-center justify-center p-0.5 shadow-xl shrink-0">
                    <img src={userData?.photoURL || (settings?.logoUrl || '/logo.png')} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] opacity-90 font-black text-blue-50 leading-tight uppercase tracking-tighter">
                    Kelas {userData?.kelas || '-'} • {settings?.schoolName || 'RA Darusyifa'}
                  </p>
                </div>
              </div>
            </div>
